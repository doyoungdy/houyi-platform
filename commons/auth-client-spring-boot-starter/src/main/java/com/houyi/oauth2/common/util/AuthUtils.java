package com.houyi.oauth2.common.util;
...
public class AuthUtils {
	...
	public static String getClientId(Authentication authentication) {
		...
		if (details instanceof String) {
			...
			if(detail.startsWith(MerchantConstant.AUTHEN_CLIENT_DETAIL_PRE)){
				clientId = detail.replace(MerchantConstant.AUTHEN_CLIENT_DETAIL_PRE, "");
			}
		}
		return clientId;
	}
