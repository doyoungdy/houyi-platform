...
-----------------------------------------sharding-databases2
CREATE SCHEMA IF NOT EXISTS demo_ds_anbang;
CREATE SCHEMA IF NOT EXISTS demo_ds_fujia;
CREATE TABLE IF NOT EXISTS demo_ds_anbang.user (
	id BIGINT NOT NULL AUTO_INCREMENT, 
	company_id varchar(32) NOT NULL,
	name varchar(50) NULL, 
	create_time datetime(0) NULL,
...
CREATE TABLE IF NOT EXISTS demo_ds_fujia.user (
	id BIGINT NOT NULL AUTO_INCREMENT, 
	company_id varchar(32) NOT NULL,
	name varchar(50) NULL, 
	create_time datetime(0) NULL,
