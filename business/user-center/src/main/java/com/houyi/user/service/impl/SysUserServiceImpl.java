...
import com.houyi.common.model.*;
import com.houyi.common.service.impl.SuperServiceImpl;
import com.houyi.user.mapper.SysRoleMenuMapper;
import com.houyi.user.model.SysUserExcel;
import com.houyi.user.mapper.SysUserMapper;
...
import com.houyi.user.mapper.SysUserRoleMapper;
import com.houyi.user.service.ISysUserService;
...
public class SysUserServiceImpl extends SuperServiceImpl<SysUserMapper, SysUser> implements ISysUserService {
    ...
    @Override
	public LoginAppUser findUserById(Long id) {
