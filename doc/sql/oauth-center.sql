...
ALTER TABLE `oauth-center`.`oauth_client_details` 
ADD UNIQUE INDEX `client_id_UNIQUE` (`client_id` ASC) VISIBLE;
...
INSERT INTO `oauth_client_details` VALUES (11, 'houyi', NULL, '$2a$10$/o.wuORzVcXaezmYVzwYMuoY7qeWXBALwQmkskXD/7C6rqfCyPrna', 'houyi', 'all', 'authorization_code,password,refresh_token,client_credentials', 'http://127.0.0.1:8080/singleLogin', NULL, 18000, 28800, '{}', 'true', '2018-12-27 00:50:30', '2018-12-27 00:50:30');