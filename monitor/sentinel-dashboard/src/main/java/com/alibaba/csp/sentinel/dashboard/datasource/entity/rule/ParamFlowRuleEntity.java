...
public class ParamFlowRuleEntity extends AbstractRuleEntity<ParamFlowRule> {
    ...
    public ParamFlowRule toParamFlowRule() {
        ...
        rule.setResource(this.rule.getResource());
        rule.setLimitApp(this.rule.getLimitApp());
        rule.setGrade(this.rule.getGrade());
        rule.setParamIdx(this.rule.getParamIdx());
        rule.setParamFlowItemList(this.rule.getParamFlowItemList());
        rule.setCount(this.rule.getCount());
        rule.setClusterMode(this.rule.isClusterMode());
        rule.setClusterConfig(this.rule.getClusterConfig());
        return rule;
    }
}
