...
public class AuthorityRuleNacosPublisher implements DynamicRulePublisher<List<AuthorityRuleEntity>> {
    ...
    public void publish(String app, List<AuthorityRuleEntity> rules) throws Exception {
        ...
        configService.publishConfig(app + NacosConfigConstant.AUTHORITY_DATA_ID_POSTFIX,
        		nacosConfigProperties.getGroupId(), 
            JSON.toJSONString(rules.stream().map(AuthorityRuleEntity::toAuthorityRule).collect(Collectors.toList())));
    }
}
